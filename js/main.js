document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        fr: {
            ...
            cert1: "<strong>Cisco:</strong> CCNA1, Sécurité des terminaux, CyberOps",
            cert2: "<strong>CNIL:</strong> Le RGPD",
            cert3: "<strong>Pix</strong> (500 points)",
            cert4: "<strong>PSC1</strong> (Premiers Secours Civiques)",
        ...
        en: {
            ...
            certificationsTitle: "Certifications",
            cert1: "<strong>Cisco:</strong> CCNA1, Endpoint Security, CyberOps",
            cert2: "<strong>CNIL:</strong> GDPR",
            cert3: "<strong>Pix</strong> (500 points)",
            cert4: "<strong>PSC1</strong> (First Aid Certification)",
