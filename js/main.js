document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        fr: {
            ...
            certCol1Title: "AUTRES :",
            certCol1Item1: "RGPD (CNIL)",
            certCol1Item2: "Pix (500 points)",
            certCol1Item3: "PSC1",
            certCol2Title: "RÉSEAU :",
            certCol2Item1: "CCNA 1",
            certCol3Title: "CYBERSÉCURITÉ :",
            certCol3Item1: "Sécurité des terminaux",
            certCol3Item2: "Introduction à la Cybersécurité",
            certCol3Item3: "CyberOps",
            ...
            exp2_title: "GAEC de la chataigneraie (Saisonnier) (2021-2024)",
            exp2_desc: "Ramassage de petits fruits. Ce travail m'a appris la patience et la minutie.",
            ...
            futureText: `J'aimerais continuer mes études en troisième année orientée systèmes et réseaux. J'ai vu qu'intégrer le BUT RT en 3ème année était une très belle opportunité. À terme, j'aimerais obtenir un diplôme de niveau bac +5, mon projet n'est pas encore clairement défini mais je compte sur mes expériences et rencontres pour l'affiner. J'ai déjà pu échanger avec un ingénieur (hors informatique) qui m'a présenté l'école d'ingénieur sous un autre angle.`,
        ...
        en: {
            ...
            certificationsTitle: "Certifications",
            certCol1Title: "OTHER:",
            certCol1Item1: "GDPR (CNIL)",
            certCol1Item2: "Pix (500 points)",
            certCol1Item3: "First Aid (PSC1)",
            certCol2Title: "NETWORK:",
            certCol2Item1: "CCNA 1",
            certCol3Title: "CYBERSECURITY:",
            certCol3Item1: "Endpoint Security",
            certCol3Item2: "Introduction to Cybersecurity",
            certCol3Item3: "CyberOps",
            experienceTitle: "Professional Experience",
            exp1_title: "Mégao (Internship) - 2025",
            exp1_desc: "Developed skills in systems and network administration. Learned corporate best practices and applied knowledge from my studies.",
            exp2_title: "GAEC de la chataigneraie (Seasonal Worker) (2021-2024)",
            exp2_desc: "Berry picking. This job taught me patience and attention to detail.",
            ...
            futureText: `I would like to continue my studies in a third year focused on systems and networks. I saw that joining the 3rd year of a BUT RT is a great opportunity. Ultimately, I aim to obtain a Master's level degree (bac +5). My plan is not yet set in stone, but I am relying on my experiences and connections to refine it. I have already spoken with an engineer (from a different field) who gave me a new perspective on engineering school.`,
